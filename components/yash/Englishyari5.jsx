                ...
                px-3 mx-auto'>
                    ...
                    <div className='flex  items-center justify-center mt-[53px] gap-[15px] max-sm:hidden'>
                        <div className='max-w-[427px] w-full h-[19px] bg-[#D9D9D9] rounded-[54px]'>
                            <div className='w-[50%] rounded-[54px] h-[19px] bg-[#30237B]'></div>
                        </div>
                        <p className='text-[20px] font-semibold'>2/4</p>
                    </div>
                    <h1 className='text-[#25232F] md:text-[36px] text-[26px] font-bold text-center pt-[32px] font-Urbanist'>Problems faced while speaking?</h1>
                    <div className='flex max-md:flex-col items-center justify-center mt-[32px] max-w-[883px] w-full mx-auto gap-[21px]'>
                        <div className='max-w-[431px] w-full'>
                            <div className='flex items-center justify-between p-[11px] border-[0.6px] border-[#C0C0C0] rounded-[5px]'>
                                <label className='font-Urbanist md:text-[24px] text-[20px] text-[#25232F] font-normal' htmlFor="edu">Sentence Construction</label>
                            ...
                            <div className='mt-[21px] flex items-center justify-between p-[11px] border-[0.6px] border-[#C0C0C0] rounded-[5px]'>
                                <label className='font-Urbanist md:text-[24px] text-[20px] text-[#25232F] font-normal' htmlFor="living">Vocabulary</label>
                                <input name='yash' id='living' type="radio" className='w-[26px] h-[26px]' />
                            </div>
                        </div>
                        <div className='max-w-[431px] w-full'>
                            <div className='flex items-center justify-between p-[11px] border-[0.6px] border-[#C0C0C0] rounded-[5px]'>
                                <label className='font-Urbanist md:text-[24px] text-[20px] text-[#25232F] font-normal' htmlFor="education">Confidence</label>
                                <input name='yash' id='education' type="radio" className='w-[26px] h-[26px]' />
                            </div>
                            <div className='mt-[21px] flex items-center justify-between p-[11px] border-[0.6px] border-[#C0C0C0] rounded-[5px]'>
                                <label htmlFor="hellow" className='font-Urbanist md:text-[24px] text-[20px] text-[#25232F] font-normal'>Grammar Error</label>
                                <input name='yash' id='hellow' type="radio" className='w-[26px] h-[26px]' />
                            </div>
                        </div>
                    </div>
                    <input name="" id="" placeholder='Problems not listed above? write here' className='resize-none font-Inter max-w-[883px] w-full mx-auto border-[1.5px] outline-none text-[18px] text-[#25232F] border-[#CBD5E1] rounded-[10px] shadow-[0px_169067px_338133px_0px_rgba(16,24,40,0.05)] flex items-center justify-center p-[15px_20px_20px_20px] mt-[32px] h-[57px] placeholder:text-[#25232F] placeholder:text-[18px] max-md:max-w-[431px]'></input>
                    <Link href="/englishyaari7" >
