...
const Englishyari6 = () => {
    return (
        <>
            <div className='bg-[url("/img/starbg.png")] overflow-auto h-[100vh] justify-center items-center bg-cover bg-center mx-auto px-[16px] py-[66px] bg-[#EEECF8]'>
                ...
                px-3 mx-auto'>
                    ...
                    <div className='flex items-center justify-center mt-[53px] gap-[15px] max-sm:hidden'>
                        <div className='max-w-[427px] w-full h-[19px] bg-[#D9D9D9] rounded-[54px]'>
                            <div className='w-[75%] rounded-[54px] h-[19px] bg-[#30237B]'></div>
                        </div>
                        <p className='text-[20px] font-semibold'>3/4</p>
                    </div>
                    <h1 className='text-[#25232F] md:text-[36px] text-[26px] font-bold text-center pt-[32px] font-Urbanist'>What is your profession?</h1>
                    <div className='flex max-md:flex-col items-center justify-center mt-[32px] max-w-[883px] w-full mx-auto gap-[21px]'>
                        <div className='max-w-[431px] w-full'>
                            <div className='flex items-center justify-between p-[11px] border-[0.6px] border-[#C0C0C0] rounded-[5px]'>
                                <label className='font-Urbanist md:text-[24px] text-[20px] text-[#25232F] font-normal' htmlFor="edu">What is your profession?</label>
                            ...
                            <div className='mt-[21px] flex items-center justify-between p-[11px] border-[0.6px] border-[#C0C0C0] rounded-[5px]'>
                                <label className='font-Urbanist md:text-[24px] text-[20px] text-[#25232F] font-normal' htmlFor="living">Business owner/Entrepreneur</label>
                                <input name='yash' id='living' type="radio" className='w-[26px] h-[26px]' />
                            </div>
                        </div>
                        <div className='max-w-[431px] w-full'>
                            <div className='flex items-center justify-between p-[11px] border-[0.6px] border-[#C0C0C0] rounded-[5px]'>
                                <label className='font-Urbanist md:text-[24px] text-[20px] text-[#25232F] font-normal' htmlFor="education">Student</label>
                                <input name='yash' id='education' type="radio" className='w-[26px] h-[26px]' />
                            </div>
                            <div className='mt-[21px] flex items-center justify-between p-[11px] border-[0.6px] border-[#C0C0C0] rounded-[5px]'>
                                <label htmlFor="hellow" className='font-Urbanist md:text-[24px] text-[20px] text-[#25232F] font-normal'>Healthcare sector</label>
                                <input name='yash' id='hellow' type="radio" className='w-[26px] h-[26px]' />
                            </div>
                        </div>
                    </div>
                    <input name="" id="" placeholder='Profession not listed above? write here' className='font-Inter max-w-[883px] w-full mx-auto border-[1.5px] outline-none text-[18px] text-[#25232F] border-[#CBD5E1] rounded-[10px] shadow-[0px_169067px_338133px_0px_rgba(16,24,40,0.05)] flex items-center justify-center p-[15px_20px_20px_20px] mt-[32px] h-[57px] placeholder:text-[#25232F] placeholder:text-[18px] max-md:max-w-[431px]'></input>
                    <Link href="/englishyaari8">
